...
$tooltipText="Sorry! We are still working on this page. If you are interested in seeing more functionality, please log in again after next milestone.";
$isLoggedin = "User is logged in";
$isNotLoggedin = "User is not logged in";
$loginLink = "Log in with Facebook!";
